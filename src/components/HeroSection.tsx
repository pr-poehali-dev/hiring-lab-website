...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center bg-dark overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 md:px-6 pt-24 pb-12 flex-1 flex flex-col justify-center">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-gray-300 font-body max-w-2xl mb-10 leading-relaxed animate-fade-in" style={{ animationDelay: "0.2s" }}>
